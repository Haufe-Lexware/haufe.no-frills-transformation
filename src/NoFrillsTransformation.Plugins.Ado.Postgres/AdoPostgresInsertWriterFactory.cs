...
namespace NoFrillsTransformation.Plugins.Ado.Postgres
{
    ...
    public class AdoPostgresInsertWriterFactory : ITargetWriterFactory
    {
        private const string PREFIX = "postgres.insert://";
        ...
        public ITargetWriter CreateWriter(IContext context, string target, IFieldDefinition[] fieldDefs, string? config)
        {
            ...
            return new AdoPostgresInsertWriter(context, config, table, fieldDefs);
        }
