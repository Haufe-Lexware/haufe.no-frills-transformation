    ...
    public class CustomOperator : IOperator
    {
        ...
        public string Evaluate(IEvaluator eval, IExpression expression, IContext context)
        {
            ...
            try
            {
                ...
                else if (null != Conditions && null != CaseFunctions && null != Otherwise) // Switch/Case
                {
                ...
                {
                    throw new InvalidOperationException("CustomOperator: No function or switch/case defined.");
                }
            }
            finally
            {
